...
import img4 from '/src/components/icons/mysql.svg';
import img5 from '/src/components/icons/vue.svg';
import img6 from '/src/components/icons/git.svg';
import img7 from '/src/components/icons/visual.svg';
import img8 from '/src/components/icons/tango.svg'
import img9 from '/src/components/icons/sap.svg';
import img10 from '/src/components/icons/Moffice.svg';
import img11 from '/src/components/icons/mysql.svg';
import img12 from '/src/components/icons/Argentina.svg';
import img13 from '/src/components/icons/EEUU.svg';
import img14 from '/src/components/icons/Aleman.svg';
import img15 from '/src/components/icons/Portugues.svg';
...
const habilidades = ref([
    {// Se crea un objeto con id, nombre y habilidades
        id: 1, nombre: 'Lenguajes de Programación', habilidades: [
            ...
            { id: 3, nombre: 'Java', nivel: 'Básico', icono: img3 },
            { id: 4, nombre: 'SQL', nivel: 'Básico', icono: img4 }
        ]
    },
    {
        id: 2, nombre: 'Frameworks y Librerías', habilidades: [
            
            { id: 1, nombre: 'Vue.js', nivel: 'Básico', icono: img5 },

        ]
    },
    {
        id: 3, nombre: 'Herramientas y Software', habilidades: [
            { id: 1, nombre: 'Git', nivel: 'Intermedio', icono: img6 },
            { id: 2, nombre: 'Visual Studio Code', nivel: 'Intermedio', icono: img7 },
            { id: 3, nombre: 'Tango Gestion', nivel: 'Avanzado', icono: img8 },
            { id: 4, nombre: 'SAP', nivel: 'Avanzado', icono: img9 },
            { id: 5, nombre: 'Microsoft Office', nivel: 'Avanzado', icono: img10 }
        ]
    },
    {
        id: 4, nombre: 'Bases de Datos', habilidades: [
  
            { id: 1, nombre: 'MySQL', nivel: 'Básico', icono: img11 },
       
        ]
    },
    {
        id: 5, nombre: 'Idiomas', habilidades: [
            { id: 1, nombre: 'Español', nivel: 'Nativo', icono: img12 },
            { id: 2, nombre: 'Inglés', nivel: 'Avanzado', icono: img13 },
            { id: 3, nombre: 'Aleman', nivel: 'Avanzado', icono: img14 },
            { id: 4, nombre: 'Portugues', nivel: 'Avanzado', icono: img15 }
        ]
    }
]);
...
.skills-contenedor {
    ...
    /*Fondo con gradiente*/
    background: linear-gradient(-45deg, #743ad5, #4207a9, #6EACDA, #d53a9d);
